...
$products_list = array(
    1 => array(
        'product_id' => '8',    //код товара (из каталога CRM)
...
// параметры запроса
$data = array(
    'key' => 'cd30a647c8f4648ba2ff3148c779ce7a', //Ваш секретный токен
...
// запрос
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, 'http://tovarserg.lp-crm.top/api/addNewOrder.html');
...
<div class="block_success">
    <h2 style="text-transform: uppercase;">Вітоємо! Ваша заявка прийнята!</h2>
    <p class="success">
        Найближчим часом з вами зв'яжеться менеджер для уточнення всіх деталей. Будь ласка, тримаєте ввімкненим ваш контактний телефон.
    </p>
    <h3 class="success">
        Будь ласка, перевірте правильність введеної Вами інформації.
    </h3>
    <div class="success">
        <ul class="list_info">
            <li><span>Імя:  </span><span id="client"><?= $_GET['name'] ?></span></li>
            <li><span>Телефон: </span><span id="tel"><?= $_GET['phone'] ?></span></li>
        </ul>
        <br/><span id="submit"></span>
    </div>
    <p class="fail success">Якщо ви помилилися при заповненні форми, то, будь ласка, <a
